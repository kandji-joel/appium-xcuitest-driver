...
export default {
   ...
   *
   * @remarks `appium-xcuitest-driver` v4.4 does not require `pymobiledevice3` to be installed.
   * @privateRemarks See implementation at https://github.com/doronz88/pymobiledevice3/blob/51f4683c5c3c385a015858ada07a5f1c62d3cf57/ios_device/cli/base.py#L220
